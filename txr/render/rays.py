...
class ray:
    ...
    tmin: float
        The maximum value that t can attain. Initialized to 
        finfo('float32').tiny
    ...
    @property
    def payload(self):
        """ three floats associated with this ray """
...
class ray_group:
    ...
    @property
    def rays(self):
        """ all the data associated with this group of rays """
        return self._rays
...
class ray_generator:
    ...
    def numdirections(self):
        """ the number of directions input """
        return self._numdirections 
    @property
    def numrays(self):
    ...
    @property
    def numorigins(self):
        """ the number of origins input """
        return self._numorigins
    @property
    def ray_group(self):
        """ the ray group generated by this class """
        return self._raygrp
    def generate(self):
        """ Generate Ray data
